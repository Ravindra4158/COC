...
const NAV_ITEMS = [
  ...
  { id: 'ranking', label: 'Vulnerability Ranking', icon: 'M3 4h18v2H3V4zm0 7h12v2H3v-2zm0 7h18v2H3v-2z', count: '10' },
    ...
    <aside className="cyber-sidebar">
      ...
      <div className="cyber-brand">
        ...
        <div className="brand-text">
          <span className="brand-title">RISK-PATCH</span>
          <span className="brand-sub">DEFENSE PLATFORM // v2.4</span>
        </div>
      </div>
